...
Original file is located at
    https://colab.research.google.com/drive/1TAJGQlnhGfmBohhyv6BUiJHDvOaKx9ap
"""
...
PATH = os.getcwd()
# Define data path
data_path = '/content/drive/MyDrive/Colab Notebooks/Character Images/Character Images'  
...
#Convulutional layer with 32 filters, Size of filters is 5, 5 and relu activation
model.add(Conv2D(32, kernel_size=5, activation ='relu'))
#Pooling layer with pool size 3,3
model.add(MaxPooling2D(pool_size=(3,3)))
#Dropout layer with rate 0.35
